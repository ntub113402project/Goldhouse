...
--
-- Host: localhost    Database: gh_members
-- ------------------------------------------------------
...
CREATE TABLE `useravatars` (
  ...
  CONSTRAINT `useravatars_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-04 16:06:35
